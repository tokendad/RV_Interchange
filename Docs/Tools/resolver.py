...
CANONICAL = {
    ...
    "repair_part_fitment_table":  "a source's own dict of {part_number: {description, applies_to}} for a shared repair/service part that fits multiple distinct end-product models -- a fits-many relationship, not a supersession chart",
...
ALIASES = {
    ...
    "parts": "repair_part_fitment_table",
...
IGNORED_KEYS = {
    ...
    "corroboration_note": "narrative note comparing this observation's data to another edition/observation's data (e.g. an older revision's narrower fitment); not itself product data",
