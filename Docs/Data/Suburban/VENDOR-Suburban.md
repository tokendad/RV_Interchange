...
**UPDATE 2026-07-31 (obs #32, #33) — retailer corroboration found for the 6-gallon Pilot
family, closing the "no retailer page" gap in part.** dyersonline.com (`SW6PE`, obs #32) and
hannarv.com (`SW6P`, obs #33) both independently list unit dimensions of
**12-11/16" × 12-11/16" × 19-3/16"** and a **12¾"×12¾" cutout** — an exact match, down to the
fraction, for the manufacturer factory sheet's 6-gallon row (§4.2: 12.6875 × 12.6875 × 19.1875).
This is real independent corroboration, not just a SKU sighting: two retailers, neither citing
the other, landed on the same numbers as the manufacturer chart.

**But it opens a SKU conflict instead of closing one.** Three retailer sources now disagree on
`SW6P`'s own SKU: mmrvonline.com gives `5117A` (already flagged in this file, uncorroborated
until now), hannarv.com gives `5054A` (obs #33, with its own vendor number `41087801`), and
