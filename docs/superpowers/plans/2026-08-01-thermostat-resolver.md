...
**Architecture:** Add a typed, qualified `component_attributes` table and matching model/store APIs. Resolve observations #44-#46 into one fixture component, and resolve observation #43 into a separate open identifier-equivalence candidate without creating unsupported compatibility or supersession edges.
...
- [ ] **Step 1: Add the failing vocabulary test**
...
- [ ] **Step 5: Add failing model assertions**
...
- [ ] **Step 1: Add failing store round-trip tests**
...
- [ ] **Step 3: Add candidate constraints and indexes**
...
- [ ] **Step 4: Implement dataclasses and store APIs**
...
**Interfaces:**
- Consumes: observations #43-#46 and APIs from Tasks 1-3.
- Produces: `thermostat_from_observations(photo_row, manual_row, positions_row,
  component_id)` and `identifier_candidate_from_observation(obs_row)`.

- [ ] **Step 1: Add failing happy-path resolver assertions**

Load #44, #45, and #46. Require component ID `c_placeholder_tstat`, part type 415, code
...
- [ ] **Step 3: Add failing candidate assertions**
...
- [ ] **Step 6: Implement the candidate builder**
...
- [ ] **Step 1: Add thermostat fixture mismatch checks**
...
- [ ] **Step 3: Complete fixture comparison and reporting**
...
- [ ] **Step 4: Refresh status documents**
...
Expected: all tests pass, 46 observations classify, and fixture mismatches equal zero.
